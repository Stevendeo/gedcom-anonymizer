...
# -*- coding: utf-8 -*-
#
# gedcom-anonymizer documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'gedcom-anonymizer.tex', 'gedcom-anonymizer Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'gedcom-anonymizer', 'gedcom-anonymizer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gedcom-anonymizer', 'gedcom-anonymizer Documentation',
     author, 'gedcom-anonymizer', 'One line description of project.',
     'Miscellaneous'),
]
