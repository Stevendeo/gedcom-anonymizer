...
If :code:`gedcom-anonymizer` is available in your opam repository, you can just call::

  opam install gedcom-anonymizer

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`gedcom-anonymizer` in a directory.
